<template>
    <BasePage :title="$t('powermetersolaradmin.PowerMeterSettings')" :isLoading="dataLoading">
        ...
        <form @submit="savePowerMeterConfig">
            <CardElement :text="$t('powermeteradmin.PowerMeterConfiguration')" textVariant="text-bg-primary">
                <InputElement
                    ...
                    v-model="PowerMeterSolarConfigList.enabled"
                    type="checkbox"
                    wide
                />

                <InputElement
                    v-show="PowerMeterSolarConfigList.enabled"
                    :label="$t('powermeteradmin.VerboseLogging')"
                    v-model="PowerMeterSolarConfigList.verbose_logging"
                    type="checkbox"
                    wide
                />

                <div class="row mb-3" v-show="PowerMeterSolarConfigList.enabled">
                    <label for="inputPowerMeterSource" class="col-sm-4 col-form-label">{{
                        $t('powermeteradmin.PowerMeterSource')
                    }}</label>
                    <div class="col-sm-8">
                        <select id="inputPowerMeterSource" class="form-select" v-model="PowerMeterSolarConfigList.source">
            ...
            <div v-if="PowerMeterSolarConfigList.enabled">
                <div v-if="PowerMeterSolarConfigList.source === 0 || PowerMeterSolarConfigList.source === 3">
                ...
                <div v-if="PowerMeterSolarConfigList.source === 0">
                    <CardElement
                        v-for="(mqtt, index) in PowerMeterSolarConfigList.mqtt.values"
                        v-bind:key="index"
                ...
                <CardElement
                    v-if="PowerMeterSolarConfigList.source === 1 || PowerMeterSolarConfigList.source === 2"
                ...
                >
                    <InputElement
                        ...
                        v-model="PowerMeterSolarConfigList.serial_sdm.polling_interval"
                        type="number"
                        min="1"
                        max="15"
                    ...
                    <InputElement
                        ...
                        v-model="PowerMeterSolarConfigList.serial_sdm.address"
                        type="number"
                        wide
                    />
                </CardElement>

                <div v-if="PowerMeterSolarConfigList.source === 3">
                    <div class="alert alert-secondary mt-5" role="alert">
                    ...
                    <CardElement :text="$t('powermeteradmin.HTTP')" textVariant="text-bg-primary" add-space>
                        <InputElement
                            ...
                            v-model="PowerMeterSolarConfigList.http_json.individual_requests"
                            type="checkbox"
                            wide
                        />
                        ...
                        <InputElement
                            :label="$t('powermeteradmin.pollingInterval')"
                            v-model="PowerMeterSolarConfigList.http_json.polling_interval"
                            type="number"
                            min="1"
                            max="15"
                            :postfix="$t('powermeteradmin.seconds')"
                    ...
                    <CardElement
                        v-for="(httpJson, index) in PowerMeterSolarConfigList.http_json.values"
                        :key="index"
                    ...
                    >
                        ...
                        <div v-if="httpJson.enabled || index == 0">
                            <HttpRequestSettings
                                ...
                                v-if="index == 0 || PowerMeterSolarConfigList.http_json.individual_requests"
                            />
                ...
                <div v-if="PowerMeterSolarConfigList.source === 6">
                    <CardElement :text="$t('powermeteradmin.HTTP_SML')" textVariant="text-bg-primary" add-space>
                        <InputElement
                            :label="$t('powermeteradmin.pollingInterval')"
                            v-model="PowerMeterSolarConfigList.http_sml.polling_interval"
                            type="number"
                            min="1"
                            max="15"
                            :postfix="$t('powermeteradmin.seconds')"
                        ...
                        <HttpRequestSettings v-model="PowerMeterSolarConfigList.http_sml.http_request" />
                    </CardElement>
...
export default defineComponent({
    ...
    data() {
        return {
            dataLoading: true,
            PowerMeterSolarConfigList: {} as PowerMeterConfig,
    ...
    methods: {
        getPowerMeterConfig() {
            ...
            fetch('/api/powermetersolar/config', { headers: authHeader() })
                .then((response) => handleResponse(response, this.$emitter, this.$router))
                .then((data) => {
                    this.PowerMeterSolarConfigList = data;
        ...
        savePowerMeterConfig(e: Event) {
            ...
            formData.append('data', JSON.stringify(this.PowerMeterSolarConfigList));

            fetch('/api/powermetersolar/config', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
        ...
        testHttpJsonRequest() {
            ...
            fetch('/api/powermetersolar/testhttpjsonrequest', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
        ...
        testHttpSmlRequest() {
            ...
            fetch('/api/powermetersolar/testhttpsmlrequest', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
