<template>
    <BasePage :title="$t('powermeterchargeradmin.PowerMeterSettings')" :isLoading="dataLoading">
        ...
        <form @submit="savePowerMeterConfig">
            <CardElement :text="$t('powermeteradmin.PowerMeterConfiguration')" textVariant="text-bg-primary">
                <InputElement
                    ...
                    v-model="PowerMeterChargerConfigList.enabled"
                    type="checkbox"
                    wide
                />

                <InputElement
                    v-show="PowerMeterChargerConfigList.enabled"
                    :label="$t('powermeteradmin.VerboseLogging')"
                    v-model="PowerMeterChargerConfigList.verbose_logging"
                    type="checkbox"
                    wide
                />

                <div class="row mb-3" v-show="PowerMeterChargerConfigList.enabled">
                    <label for="inputPowerMeterSource" class="col-sm-4 col-form-label">{{
                        $t('powermeteradmin.PowerMeterSource')
                    }}</label>
                    <div class="col-sm-8">
                        <select id="inputPowerMeterSource" class="form-select" v-model="PowerMeterChargerConfigList.source">
            ...
            <div v-if="PowerMeterChargerConfigList.enabled">
                <div v-if="PowerMeterChargerConfigList.source === 0 || PowerMeterChargerConfigList.source === 3">
                ...
                <div v-if="PowerMeterChargerConfigList.source === 0">
                    <CardElement
                        v-for="(mqtt, index) in PowerMeterChargerConfigList.mqtt.values"
                        v-bind:key="index"
                ...
                <CardElement
                    v-if="PowerMeterChargerConfigList.source === 1 || PowerMeterChargerConfigList.source === 2"
                ...
                >
                    <InputElement
                        ...
                        v-model="PowerMeterChargerConfigList.serial_sdm.polling_interval"
                        type="number"
                        min="1"
                        max="15"
                    ...
                    <InputElement
                        ...
                        v-model="PowerMeterChargerConfigList.serial_sdm.address"
                        type="number"
                        wide
                    />
                </CardElement>

                <div v-if="PowerMeterChargerConfigList.source === 3">
                    <div class="alert alert-secondary mt-5" role="alert">
                    ...
                    <CardElement :text="$t('powermeteradmin.HTTP')" textVariant="text-bg-primary" add-space>
                        <InputElement
                            ...
                            v-model="PowerMeterChargerConfigList.http_json.individual_requests"
                            type="checkbox"
                            wide
                        />
                        ...
                        <InputElement
                            :label="$t('powermeteradmin.pollingInterval')"
                            v-model="PowerMeterChargerConfigList.http_json.polling_interval"
                            type="number"
                            min="1"
                            max="15"
                            :postfix="$t('powermeteradmin.seconds')"
                    ...
                    <CardElement
                        v-for="(httpJson, index) in PowerMeterChargerConfigList.http_json.values"
                        :key="index"
                    ...
                    >
                        ...
                        <div v-if="httpJson.enabled || index == 0">
                            <HttpRequestSettings
                                ...
                                v-if="index == 0 || PowerMeterChargerConfigList.http_json.individual_requests"
                            />
                ...
                <div v-if="PowerMeterChargerConfigList.source === 6">
                    <CardElement :text="$t('powermeteradmin.HTTP_SML')" textVariant="text-bg-primary" add-space>
                        <InputElement
                            :label="$t('powermeteradmin.pollingInterval')"
                            v-model="PowerMeterChargerConfigList.http_sml.polling_interval"
                            type="number"
                            min="1"
                            max="15"
                            :postfix="$t('powermeteradmin.seconds')"
                        ...
                        <HttpRequestSettings v-model="PowerMeterChargerConfigList.http_sml.http_request" />
                    </CardElement>
...
export default defineComponent({
    ...
    data() {
        return {
            dataLoading: true,
            PowerMeterChargerConfigList: {} as PowerMeterConfig,
    ...
    methods: {
        getPowerMeterConfig() {
            ...
            fetch('/api/powermetercharger/config', { headers: authHeader() })
                .then((response) => handleResponse(response, this.$emitter, this.$router))
                .then((data) => {
                    this.PowerMeterChargerConfigList = data;
        ...
        savePowerMeterConfig(e: Event) {
            ...
            formData.append('data', JSON.stringify(this.PowerMeterChargerConfigList));

            fetch('/api/powermetercharger/config', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
        ...
        testHttpJsonRequest() {
            ...
            fetch('/api/powermetercharger/testhttpjsonrequest', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
        ...
        testHttpSmlRequest() {
            ...
            fetch('/api/powermetercharger/testhttpsmlrequest', {
                method: 'POST',
                headers: authHeader(),
                body: formData,
            })
