...
#define POWERLIMITER_INVERTER_METER_NOT_STATS false
#define POWERLIMITER_DO_NOT_WAIT_FOR_STATS false
...
#define HUAWEI_MAX_CURRENT_MULTIPLIER 20
...
#define HUAWEI_CHARGER_METER_NOT_CHARGER false
